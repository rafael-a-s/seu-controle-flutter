  ...
  void binds(Injector i) {
    i.addSingleton<MonthlyContributionDatasource>(() =>
        MonthlyContributionDatasourceImpl(
            client:
                FirebaseFirestore.instance.collection('monthlyContribution'),
            api: 'monthly-contribution'));
    i.addSingleton<MonthlyContributinoBloc>(() => MonthlyContributinoBloc(datasource: i.get<MonthlyContributionDatasource>()));
  }
