...
class CardListRemunerationComponent extends StatefulWidget {
  final int id;
  final Remuneration remuneration;
  const CardListRemunerationComponent(
      {required this.id, required this.remuneration, super.key});

  @override
  State<CardListRemunerationComponent> createState() =>
      _CardContributionComponentState();
}

class _CardContributionComponentState extends State<CardListRemunerationComponent> {
  @override
